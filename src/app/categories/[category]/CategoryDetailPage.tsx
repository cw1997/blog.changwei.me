...
import { articlePath, languageLabel } from "@/lib/site";
...
export function CategoryDetailPage(props: Readonly<CategoryDetailPageProps>) {
  const { decodedCategory, articles } = props;
