...
import { articlePath, buildArticlesHref, categoryPath, languageLabel, tagPath } from "@/lib/site";
...
export function ArticlesPage(props: Readonly<ArticlesPageProps>) {
  const { articles, categories, tags, selectedCategory, selectedTag } = props;
