...
import { articlePath, languageLabel, tagPath } from "@/lib/site";
...
export function TagDetailPage(props: Readonly<TagDetailPageProps>) {
  const { decodedTag, selectedCategory, categories, articles } = props;
