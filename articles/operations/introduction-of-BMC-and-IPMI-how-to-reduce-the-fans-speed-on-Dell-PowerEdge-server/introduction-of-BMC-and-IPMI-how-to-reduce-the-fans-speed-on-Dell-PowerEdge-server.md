...
[Intel IPMI Home Page](https://www.intel.com/content/www/us/en/products/docs/servers/ipmi/ipmi-home.html)
...
![Plug in the network cable to LAN port 1](./plug-in-the-network-cable-to-port-1.jpg)
...
![Remember DRAC IPv4 address](./remember-DRAC-IPv4.jpg)

然后记下这个IP

接着，有个开源工具叫做ipmitool能够帮助我们与IPMI的BMC设备通信。

[ipmitool/ipmitool](https://github.com/ipmitool/ipmitool)（IPMI 工具）

在这个github仓库的release中我们可以下载到它的可执行文件

[ipmitool Releases](https://github.com/ipmitool/ipmitool/releases)
...
[dell_fans_controller Releases](https://github.com/cw1997/dell_fans_controller/releases)

下载地址： [dell_fans_controller_v1.0.0.zip](https://github.com/cw1997/dell_fans_controller/releases/download/v1.0.0/dell_fans_controller_v1.0.0.zip)
