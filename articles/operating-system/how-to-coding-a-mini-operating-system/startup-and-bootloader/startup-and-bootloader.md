...
![The Definitive Guide to ARM Cortex-M3 page 49](./the-definitive-guide-to-the-arm-cortex-3-page-49.png)
...
![startup_stm32f10x file content](./startup-stm32f10x-file-content.png)
...
![SystemInit function](./system-init.png)
...
![STM32 register definition](./stm32-register-definition.png)

STM32CubeMX 这个由 ST 官方提供的工具也可以更加直观的查看全局时钟树的关联关系。

![STM32 global clock tree](./stm32-global-clock-tree.png)
