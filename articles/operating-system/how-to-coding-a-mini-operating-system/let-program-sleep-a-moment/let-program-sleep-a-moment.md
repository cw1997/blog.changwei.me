...
![STC-ISP generate delay code](./stc-isp-generate-delay-code.png)
...
![STC-ISP generate delay code ASM](./stc-isp-generate-delay-code-asm.png)
...
由于这种延时方式为通过软件指令耗时的方式实现，因此也称为软件延时。
...
![Sleep function](./sleep-function.png)
...
![Enhanced switch_current_TCB function](./enhance-function-switch-current-tcb.png)
...
![Simulate for test sleep](./simulate-for-test-sleep.png)
